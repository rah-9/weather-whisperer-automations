...
import { Thermometer, Wind, Droplets, Eye, Clock, MapPin, CheckCircle, XCircle, Brain } from 'lucide-react';
...
const WeatherDisplay: React.FC<WeatherDisplayProps> = ({ weatherData }) => {
  ...
  return (
    <div className="animate-slide-up">
      <Card className="w-full shadow-2xl bg-white/95 backdrop-blur-sm border-0 overflow-hidden hover:shadow-3xl transition-all duration-500">
        <CardHeader className="bg-gradient-to-r from-green-50 to-emerald-50 pb-6">
          <CardTitle className="text-2xl font-bold text-gray-800 flex items-center gap-3 animate-scale-in">
        ...
        <CardContent className="p-8 space-y-8">
          {/* Location Header */}
          <div className="text-center p-6 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl border border-blue-100 transform hover:scale-[1.02] transition-transform duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-2xl border border-blue-200 text-center transform hover:scale-105 transition-all duration-300 hover:shadow-lg">
              <Thermometer className="w-8 h-8 text-blue-600 mx-auto mb-3 animate-bounce-slow" />
            ...
            <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 p-6 rounded-2xl border border-cyan-200 text-center transform hover:scale-105 transition-all duration-300 hover:shadow-lg">
            ...
            {weatherData.weatherData?.current?.wind_kph && (
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-2xl border border-purple-200 text-center transform hover:scale-105 transition-all duration-300 hover:shadow-lg">
            ...
            {weatherData.weatherData?.current?.humidity && (
              <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-2xl border border-green-200 text-center transform hover:scale-105 transition-all duration-300 hover:shadow-lg">
          ...
          {weatherData.aiCommentary && (
            <div className="bg-gradient-to-r from-indigo-50 to-purple-50 p-6 rounded-2xl border border-indigo-200 animate-fade-in">
          ...
          {/* Air Quality Section */}
          <div className={`p-6 rounded-2xl border transition-all duration-300 hover:shadow-lg ${aqiStatus ? aqiStatus.bgColor + ' border-current' : 'bg-gray-50 border-gray-200'}`}>
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              {aqiStatus && (
                <Badge className={`${aqiStatus.color} text-white text-lg px-4 py-2 animate-pulse`}>
                  {aqiStatus.text}
                </Badge>
              )}
            </div>
          ...
          {/* User Information */}
          <div className="bg-gradient-to-r from-emerald-50 to-green-50 p-6 rounded-2xl border border-emerald-200 transform hover:scale-[1.01] transition-transform duration-300">
          ...
          {/* Status Banner */}
          <div className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white p-6 rounded-2xl text-center transform hover:scale-[1.02] transition-transform duration-300 animate-fade-in">
            <h3 className="text-xl font-semibold mb-2">✅ Report Generated Successfully</h3>
            <p className="text-blue-100">
              Weather data has been processed and stored. An AI-powered email report with personalized recommendations is ready for you.
            </p>
          </div>
        </CardContent>
      </Card>
